 ...
 */
metadata {
	definition (name: "Yale Keyless Lock", namespace: "nemiah", author: "TmpR") {
		capability "Actuator"
		capability "Lock"
		capability "Polling"
		capability "Refresh"
	...
	tiles(scale: 2) {
		...
		standardTile("unlock", "device.unlock", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
...
def zwaveEvent(physicalgraph.zwave.commands.alarmv2.AlarmReport cmd) {
	...
	if (cmd.zwaveAlarmType == 6) {
		...
		case 130:  // Yale YRD batteries replaced
			map = [ name: "battery", value: "100", descriptionText: "$device.displayName batteries replaced", isStateChange: true ]
			break
		case 131:
